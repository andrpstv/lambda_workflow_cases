...
func Model2Activity(ctx context.Context, input workflowforeachstep.Input) (string, error) {
	...
	byteResp, err := workflowforeachstep.CallService(workflowforeachstep.Model2URL, byteReq)
	if err != nil {
