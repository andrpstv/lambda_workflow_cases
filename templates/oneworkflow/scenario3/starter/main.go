...
func main() {
	...
	input.RemoteExecuteParams["FeatureStore"] = oneworkflow.RemoteRequest{DelaySec: 10, RespSizeKb: 5}
	input.RemoteExecuteParams["RiskAvatar"] = oneworkflow.RemoteRequest{DelaySec: 10, RespSizeKb: 5}
	input.RemoteExecuteParams["RiskParams"] = oneworkflow.RemoteRequest{DelaySec: 10, RespSizeKb: 5}
