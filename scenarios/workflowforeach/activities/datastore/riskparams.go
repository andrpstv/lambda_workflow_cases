...
func RiskParamsActivity(ctx context.Context, input workflowforeachstep.Input) (string, error) {
	...
	byteResp, err := workflowforeachstep.CallService(workflowforeachstep.RiskParamsURL, byteReq)
	if err != nil {
